# This file provides an example importer for GRIB files
# which can be used to extract the data required to use the plugin.
...
class IncaGribImporter:
    ...
    # Convert dictionary to 3D function
    def inca_dictionary_to_3Dmatrix(self, incaDict):
